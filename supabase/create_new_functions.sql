-- Создание новых функций контактов с исправленными параметрами

-- 1. Функция для получения списка контактов пользователя
...
-- 2. Функция для добавления контакта
...
-- 3. Функция для удаления контакта
...
-- 4. Функция для создания чата с контактом
...
-- Тестируем функции
SELECT 'New functions created successfully' as status;
